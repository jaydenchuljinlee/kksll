...
<body>
	...
	<div class="container">
        ...
        <div class="col-lg-12 mb-4">
          <form name="sentMessage" id="contactForm" action="faq.jsp" novalidate>
          	 ...
          	 <div class="row mb-2">
				...
				<div class="mt-4 col-2">
					<button type="submit" id="sendMessageButton" class="form-control form-control-sm btn btn-secondary faq_btn_success">문의하기</button>
				</div>
			</div>
